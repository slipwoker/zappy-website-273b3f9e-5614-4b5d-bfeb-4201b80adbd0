...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (phoneHeaderBtn) {
    phoneHeaderBtn.addEventListener('click', function() {
      const phoneNumber = '1-905-763-9000';
      ...
      if (window.zappyContactFormLoaded) {
        (async function() {
          try {
            ...
            const zappyPayload = {
              websiteId: '273b3f9e-5614-4b5d-bfeb-4201b80adbd0',
              name: name,
              email: email,
              subject: service ? 'Contact Form - ' + service : 'Contact Form Submission',
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Amazon Railings uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
